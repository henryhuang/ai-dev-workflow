...
5. Confirm the test fails for the expected reason when feasible.
...
- Call out cases where reproduction is impossible or nondeterministic.
- If the bug cannot be reproduced, gather evidence before making speculative changes.
